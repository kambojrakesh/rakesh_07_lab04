...
```{r Even checker, warning=FALSE, include=FALSE}
...
```{r Event number counter, cache=FALSE, echo=FALSE}
#echo : display the code along with the result
...
\`\`\`date`: (Rakesh Kumar), author`: (September 27, 2022)\`\`\`
